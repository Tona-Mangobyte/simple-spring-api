...
public class JwtTokenUtil implements Serializable {
    ...
    private String secret = "simple-jwt";
    ...
    private AuthResponse doGenerateToken(Map<String, Object> claims, String subject) {

        Long expired = JWT_TOKEN_VALIDITY * 1000;
        ...
        return new AuthResponse(accessToken, expired);
    }
